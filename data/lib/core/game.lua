RashidDays =
   {
      [1] = {town='Darashia',pos=Position(33239,32482,7)}, --Darashia
      [2] = {town='Edron',pos=Position(33170,31807,6)}, --Edron
      [3] = {town='Port Hope',pos=Position(32576,32752,7)}, --Port Hope
      [4] = {town='Ankrahmun',pos=Position(33067,32880,6)}, --Ankrahmun
      [5] = {town='Darashia',pos=Position(33239,32482,7)}, --Darashia
      [6] = {town='Edron',pos=Position(33170,31807,6)}, --Edron
      [7] = {town='Carlin',pos=Position(32328,31782,6)} --Carlin
   }
function decimalPlace(val)
	local digits = 1 
